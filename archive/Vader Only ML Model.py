...
X_train, X_test, y_train, y_test = train_test_split(
    feature_set.drop(['date', 'closing_price', 'sentiment_vader_score'], axis=1),  # Exclude date and closing_price from features
...
result_df_test = pd.DataFrame({
    ...
    'Actual Closing Price': y_test,
    'Predicted Closing Price': y_pred_test,
    #'Sentiment Score': X_test['sentiment_vader_score'],
...
result_df_train = pd.DataFrame({
    ...
    #'Sentiment Score': X_train['sentiment_vader_score'],
