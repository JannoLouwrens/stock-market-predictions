...
merged_data_tesla['lag_flair_sentiment_score_1'] = merged_data_tesla['flair_sentiment_score'].shift(2)
merged_data_tesla['lag_textblob_sentiment_score_1'] = merged_data_tesla['textblob_sentiment_score'].shift(2)
merged_data_tesla['lag_vader_sentiment_score_1'] = merged_data_tesla['vader_sentiment_score'].shift(2)
